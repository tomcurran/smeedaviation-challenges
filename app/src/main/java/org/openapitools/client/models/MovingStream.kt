...
import org.openapitools.client.models.MovingStreamAllOf
 ...
 * @param data The sequence of moving values for this stream, as boolean values
 */
...
data class MovingStream (
    ...
    val resolution: MovingStream.Resolution? = null,
    /* The base series used in the case the stream was downsampled */
    @Json(name = "series_type")
    val seriesType: MovingStream.SeriesType? = null,
    /* The sequence of moving values for this stream, as boolean values */
    @Json(name = "data")
    val data: kotlin.Array<kotlin.Boolean>? = null
) {
